export class Constants {
    static readonly ARTSCRIPTION_COUNT: string = "ARTSCRIPTION_COUNT";
    static readonly ARTSCRIPTION_STORAGE_PREFIX: string = "ARTSCRIPTION#";
    static readonly ARTSCRIPTION_EXECUTION: string = "ARTSCRIPTION_EXECUTION#";
